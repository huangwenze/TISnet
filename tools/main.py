...
from tisnet import train, validate, inference, log_print, compute_saliency, compute_saliency_img, compute_high_attention_region
#compute_high_attention_region

# from tisnet.engine.train_loop import 
from tisnet.model.utils import GradualWarmupScheduler
from tisnet.loader import SeqicSHAPE
from tisnet.utils import datautils
...
def main():
    ...
    # Training settings
    parser = argparse.ArgumentParser(description='Official version of TISnet')
    # Data options
    ...
    parser.add_argument('--arch',           default="TISnet", help='network architecture')
